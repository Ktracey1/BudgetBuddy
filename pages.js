    ...
    <main className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center p-6 bg-white">
      <div className="max-w-3xl text-center space-y-8">
        ...
        <h1 className="text-5xl md:text-6xl font-black text-gray-900 tracking-tight">
          Shop Smarter with <span className="text-pink-600">PriceWise</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          ...
          <button className="bg-white text-gray-700 border-2 border-gray-100 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-50 transition">
            How it works
          </button>
        </div>
      </div>
